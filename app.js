...
<div style="padding: 10px 15px; background-color: #f8f9fa; border-bottom: 1px solid #e0e0e0;">
    <div style="display: flex; flex-direction: column; gap: 5px;">
        <label for="dateRangeAbsensiAll" style="font-weight: 500; color: #555; font-size: 13px;">Periode:</label>
        <select id="dateRangeAbsensiAll" style="width: 100%; padding: 8px 12px; border: 1px solid #ddd; border-radius: 6px; background-color: white; font-size: 14px;">
            <option value="week" selected>7 Hari Terakhir</option>
            <option value="month">Bulan Ini</option>
            <option value="lastMonth">Bulan Lalu</option>
        </select>
...
async function calculateTargetAchievement(namaKaryawan, outlet, bulan, tahun, 
    ...
    try {
        ...
        if (result.status_omset >= 100) {
            result.bonus_omset = result.achievement_omset * 0.00 * result.proporsi_kasir;
